...
async function sendSP() {
  ...
  if (response.status === 200) { //クエストクリアを実装
    ...
    document.getElementById("comp_check").innerHTML =
      `<center>Error Occurred<br>${error_message}<br><small>プロフィールへ戻ります</small></center>`;
